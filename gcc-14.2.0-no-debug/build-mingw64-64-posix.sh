...
GCC_LANGS="c,c++"
GCC_CONFIG="--enable-languages=${GCC_LANGS} --enable-seh-exceptions --enable-threads=posix --disable-nls --disable-shared --enable-static --enable-fully-dynamic-string --enable-lto --enable-plugins --enable-libgomp --with-dwarf2 --enable-mingw-wildcard=platform --disable-win32-registry --enable-version-specific-runtime-libs --prefix=${PREFIX} --with-sysroot=${PREFIX} --target=x86_64-w64-mingw32 --enable-targets=all --enable-checking=release"
